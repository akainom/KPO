...
namespace LT
{
	...
	LT::Entry::Entry(const char lex_parent, const char lex, int str_n, int idxTI)
	{
		this->lexema_parent = lex_parent;
		this->lexema = lex;
		this->sn = str_n;
		this->idxTI = idxTI;
	}
	LT::Entry::Entry(char lex, int str_n, int idxLT, int idxTI)
	{
		this->lexema = lex;
		this->sn = str_n;
		this->idxLT = idxLT;
